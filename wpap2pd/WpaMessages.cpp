...
using map_type = std::unordered_map<std::string, WpaEventMessage>;
...
static std::vector<std::string> ReverseMap()
{
     ...
     result.resize((size_t)WpaEventMessage::MAX_MESSAGE);
...
static std::vector<std::string> messageToString = ReverseMap();
